...
enum
{
	...
	DEBUGGER_CMD_UPLOAD_EXECUTABLE = 12,
	DEBUGGER_CMD_GET_EXECUTABLE_LOAD_ADDRESS = 13,
	...
	DEBUGGER_TARGET_RESPONSE_UPLOAD_EXECUTABLE = 140,
	DEBUGGER_TARGET_RESPONSE_GET_EXECUTABLE_LOAD_ADDRESS = 141,
