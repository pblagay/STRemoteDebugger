...
#define STRING_MAGIC_NUMBER			0x12345678
...
/////////////////////////////////////////////////////////////
// SprintfBuffInc
// Sprintf to a buffer, incrementing the pointer
s32 String::SprintfBuffInc(char** Buff, const char* fmt, ...)
{
	va_list args;
	char	str[512];
	u32		numchars;
...
/////////////////////////////////////////////////////////////
// FprintfBuffInc
// Fprintf to a buffer, incrementing the pointer (adds 0x0D, 0x0A)
s32 String::FprintfBuffInc(char** Buff, const char* fmt, ...)
{
	va_list args;
	char	str[512];
	u32		numchars;
	...
	*Buff += numchars;
	...
	numchars++;			// for 0 terminator		PAB: TODO not 100% correct.. revisit

	return numchars;
}

#if 0 // PAB work in progress
///////////////////////////////////////////////////////////
// Replacement sprintf.. from MS stdlib
s32 String::Sprintf( const char* Str, const char* FormatStr, ... )
{
    va_list		Args;

    va_start( Args, FormatStr );

	StrLen = String::Vsprintf( Str, FormatStr, Args );
    ASSERT( Safety == STRING_MAGIC_NUMBER );
    return( StrLen );
}
...
static
s32 dtoa( const char* fmtbase, f64 fpnum, char cvt, s32 width, s32 prec )
{
    char    fwork[WORKSIZE];
    char*   fw;
...
//================================================================
static
void WriteToBuffer(char** TempBufferPtr, const char* String, s32 Size )
{
    s32 i;
